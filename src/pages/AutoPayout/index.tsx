...
const QuoteContent = ({ quote }: any) => {
  ...
  return (
    <>
      ...
      <div className="subtitle is-3 has-text-weight-medium">
        {quote.targetAmount}
      </div>
      <div className="is-6 has-text-weight-light">
        Source Amount:{" "}
        <span className="has-text-weight-medium">{quote.sourceAmount} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Source: <span className="has-text-weight-medium">{quote.source} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Target: <span className="has-text-weight-medium">{quote.target} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Rate type:{" "}
        <span className="has-text-weight-medium">{quote.rateType} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Rate: <span className="has-text-weight-medium">{quote.rate} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Fee: <span className="has-text-weight-medium">{quote.fee} </span>
      </div>
    </>
  );
};
...
const TransferContent = ({ transfer, quote }: any) => {
  if (!transfer || !quote) {
    return (
      <>
        <div className="is-7">{!quote ? "Waiting..." : "Transferring..."}</div>
      </>
    );
  }
  return (
    <>
      <div className="title is-6 has-text-weight-light">Target Amount:</div>
      <div className="subtitle is-3 has-text-weight-medium">
        {transfer.targetValue}
      </div>
      <div className="is-6 has-text-weight-light">
        Reference / Contract:{" "}
        <span className="has-text-weight-medium">{transfer.reference} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Source Currency:{" "}
      ...
      <div className="is-6 has-text-weight-light">
        Source Value :{" "}
        <span className="has-text-weight-medium">{transfer.sourceValue} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Target Currency:{" "}
        <span className="has-text-weight-medium">
      ...
      <div className="is-6 has-text-weight-light">
        Target Value:{" "}
        <span className="has-text-weight-medium">{transfer.targetValue} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Fee: <span className="has-text-weight-medium">{transfer.rate} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Status:{" "}
        <span className="has-text-weight-medium">
          {status_translate[transfer.status]}{" "}
        </span>
      </div>
    </>
  );
...
const FundContent = ({ fund, transfer }: any) => {
  if (!fund || !transfer) {
    return (
      <>
        <div className="is-7">{!transfer ? "Waiting..." : "Funding..."}</div>
      </>
    );
  }
  return (
    <>
      ...
      <div className="is-6 has-text-weight-light">
        Type: <span className="has-text-weight-medium">{fund.type} </span>
      </div>
      <div className="is-6 has-text-weight-light">
        Status: <span className="has-text-weight-medium">{fund.status} </span>
      </div>
    </>
  );
};
...
const AutoPayout: React.FC = ({ location }: any) => {
  ...
  useEffect(() => {
    ...
    const contract = contracts.find(
      contract => contract.id === toNumber(params.contract)
    );
    ...
    const fundTransfer = async (body: any) => {
      try {
        const response = await API(
          "POST",
          `v3/profiles/${profile_id}/transfers/${transfer.id}/payments`,
          body
        );
      ...
      <div id="AutoPayout">
        ...
        <div className="columns is-multiline">
          <div className="column is-one-third">
            <div className="card">
              <header className="card-header">
                <p className="card-header-title">Quote</p>
              </header>
          ...
          <div className="column is-one-third">
            <div className="card">
              <header className="card-header">
                <p className="card-header-title">Transfer</p>
              </header>
              <div className="card-content">
          ...
          <div className="column is-one-third">
            <div className="card">
              <header className="card-header">
                <p className="card-header-title">Fund</p>
              </header>
              <div className="card-content">
